...
- Keep context lean: read files via scripts/tools, not by pasting full contents. It’s OK to write small ephemeral Node snippets to parse JSON and return only the fields you need for the current mapping.
